  ...
  const articles = [
    {
      ...
      description: "Scopri il nostro team di professionisti e la loro passione per la cura del tuo stile. Ogni taglio è un'opera d'arte.",
      link: "#",
    },
    {
      id: 2,
      ...
      description: "Offriamo trattamenti personalizzati per capelli sani e forti. Lasciati coccolare dai nostri esperti.",
      link: "#",
    },
    {
      id: 3,
      ...
      description: "La tua barba, il nostro impegno. Dai prodotti specifici ai trattamenti di precisione, pensiamo a tutto noi.",
      link: "#",
    },
  ];
        ...
        {articles.map((article) => (
          <div key={article.id} className="text-center">
            ...
            <div className="bg-white p-4">
              <h3 className="text-xl font-medium text-gray-800">{article.title}</h3>
