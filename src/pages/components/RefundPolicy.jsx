      ...
      <div className="max-w-2xl">
        ...
        <section className="mb-6">
          ...
          <ul className="list-disc list-inside">
            ...
            <li>Il reso è stato richiesto entro <span className="text-yellow-500">14 giorni</span> dalla data di consegna.</li>
          </ul>
        </section>

        <section className="mb-6">
          <h2 className="text-2xl font-semibold mb-4">Procedura per Richiedere un Rimborso</h2>
          <p>Per avviare la procedura di rimborso, segui questi passaggi:</p>
        ...
        <section className="mb-6">
          ...
          <p>
            ...
            il metodo di pagamento originale entro <span className="text-yellow-500">5-7 giorni</span> lavorativi.
            Ti invieremo una conferma via email quando il rimborso sarà stato completato.
          </p>
        </section>

        <section className="mb-6">
          <h2 className="text-2xl font-semibold mb-4">Eccezioni</h2>
          <p>Non possiamo accettare richieste di rimborso nei seguenti casi:</p>
          <ul className="list-disc list-inside">
            <li>Prodotti utilizzati o non restituiti nelle condizioni originali.</li>
            <li>Richieste effettuate oltre i <span className="text-yellow-500">14 giorni</span> dalla data di consegna.</li>
